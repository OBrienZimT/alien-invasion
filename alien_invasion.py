...
loses a ship. If the player loses three ships, the game end.
'''
import sys
...
class AlienInvasion():
	...
	def _check_bullet_alien_collisions(self):
		...
		# Remove any bullets and aliens that colloded.
	...
	def _create_fleet(self):
		...
		# Determine the number of rows of aliens that fiton the screen.
